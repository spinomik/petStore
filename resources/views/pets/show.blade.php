                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $pet['id'] }}" readonly>
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $pet['category']['name'] }}" readonly>
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text"><strong>Status:</strong></span>
                            <input type="text" class="form-control" value="{{ $pet['status'] }}" readonly>
                        </div>
                    </div>
                                ...
                                @foreach ($pet['photoUrls'] as $index => $photo)
                                    <div class="carousel-item @if ($index === 0) active @endif">
                                        <img src="{{ $photo }}" class="d-block w-100"
                                            alt="Photo of {{ $pet['name'] }}" style="height: 300px; object-fit: cover;">
                                    </div>
                                @endforeach
                            </div>
